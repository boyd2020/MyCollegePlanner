...
import com.b96software.schoolplannerapp.pagerfragments.MonthlyPagerFragment;
import com.b96software.schoolplannerapp.util.Utils;

import java.util.ArrayList;

public class MonthlyEventPager extends FragmentStatePagerAdapter {
    ...
    public MonthlyEventPager(FragmentManager fm, ArrayList<Long> dates) {
        super(fm);
        this.dates = dates;
    }
    ...
    public Fragment getItem(int position) {
        ...
        Fragment fragment = new MonthlyPagerFragment();
