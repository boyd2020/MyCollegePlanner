...
public class NoteFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>, ItemClickedListener<Note>,
        NoteListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        startDate = getArguments().getString(Utils.KEY_START_DATE);
        endDate = getArguments().getString(Utils.KEY_END_DATE);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        return handler.getNotesBetweenDatesFromDB(startDate, endDate);
    }
