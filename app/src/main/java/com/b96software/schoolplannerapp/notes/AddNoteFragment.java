...
public class AddNoteFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getActivity().setTitle(getString(R.string.note_add));
        ...
        {
            noteTitle.setText(savedInstanceState.getString(BundleUtils.BUNDLE_NOTE_TITLE));
            noteDesc.setText(savedInstanceState.getString(BundleUtils.BUNDLE_NOTE_DESC));
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(BundleUtils.BUNDLE_NOTE_TITLE, noteTitle.getText().toString());
        outState.putString(BundleUtils.BUNDLE_NOTE_DESC, noteDesc.getText().toString());
    }
    ...
    public void saveNote()
    {
        ...
        int type = Utils.NOTE_TEXT_TYPE;

        Note n = new Note(title, desc, date, type);
        new NoteHandler(getContext()).addNote(n);
        getActivity().finish();
    }
